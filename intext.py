...
# json from <see gjfc>
import json
# random from <see fdfh>
import random
# sys from <see jeii>
import sys
# pathlib from <see gaca>, using Path class is from <see gaca: Introduction section>
...
for p in paths:
    ...
    while True:
        ...
        # <see cabb> code would fail to be processed by InText as the break
        ...
        if not validKey:
            ...
            # from <see cabb> if continue were to occur as the beginning
